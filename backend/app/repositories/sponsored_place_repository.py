...
class SponsoredPlaceRepository:
    ...
    def get_by_id(self, place_id: int) -> SponsoredPlace | None:
        return self.db.get(SponsoredPlace, place_id)
    ...
    def get_for_business(self, business_id: int, place_id: int) -> SponsoredPlace | None:
        statement = select(SponsoredPlace).where(
    ...
    def list_all(
        ...
        *,
        ...
        statement = select(SponsoredPlace).order_by(SponsoredPlace.created_at.desc())
